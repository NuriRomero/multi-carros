								...
								<div class="search-form">
									...
									<div class="form-group cars-categories">
										...
										<select class="wide" id="cars-brand-selector">
											...
											<?php
											$cars_brand = get_terms( array( 'taxonomy' => 'brand' ) );
										...
										<select class="wide" id="cars-fuel-selector">
											<option value="">Todos los tipos de combustibles</option>
											<?php
											$cars_fuel = get_terms( array( 'taxonomy' => 'fuel' ) );
										...
										<select class="wide" id="cars-condition-selector">
											<option value="">Todas las condiciones de autos</option>
											<?php
											$cars_condition = get_terms( array( 'taxonomy' => 'condition' ) );
										...
										<select class="wide" id="cars-type_car-selector">
											<option value="">Todos los tipos de auto</option>
											<?php
											$cars_types = get_terms( array( 'taxonomy' => 'type_car' ) );
