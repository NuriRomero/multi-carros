                            ...
                            <div class="col-lg-2 col-md-6 col-sm-12">
                                <div class="widget categories-widget mb-40 wow fadeInUp" data-wow-delay="30ms">
                                    ...
                                    <ul class="categories-link">
                                        ...
                                        <li><a href="#">Tipo de combustible</a></li>
                                        <li><a href="#">Condicion de auto</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="widget newsletter-widget mb-40 wow fadeInUp" data-wow-delay="40ms">
                                    ...
                                    <form>
                                        <div class="form_group">
                                            <input type="email" class="form_control" placeholder="Ingrese su correo" name="email" required>
                                        </div>
                                        <div class="form_group">
                                            <button class="main-btn">Suscribirse</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
