...
class Parser extends ParserAbstract {
	...
	protected function parseClassElement() {
		...
		if ( $def = $this->parseMethodDefinition() ) {
			...
			return $def;
		} elseif ( $this->features->classFields ) {
