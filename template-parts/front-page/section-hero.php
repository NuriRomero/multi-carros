                    ...
                    <div class="hero-content">
                        ...
                        <form class="row">
                            <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
                                <label for="cars-condition-selector">Condición</label>
                                <select class="wide filtro-select" id="cars-condition-selector">
                                    <option data-display="Todas las condiciones" value="Mostrar Todas">Todas las condiciones</option>
                                    <?php
                                    $args = array(
                                        'orderby' => 'name',
                                        'order'   => 'ASC',
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
                                <label for="cars-type_car-selector">Tipo de auto</label>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
                                <label for="cars-brand-selector">Marca</label>
                            ...
                            <!-- Repite este bloque para cada select -->
                            <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
                                <label for="cars-fuel-selector">Tipo de combustible</label>
                                <select class="wide filtro-select" id="cars-fuel-selector" name="fuel">
                                    <option data-display="Todos los tipos de combustible" value="Mostrar Todas">Todos los tipos de combustible</option>
                                    <?php
                                    $args = array(
                                        'orderby' => 'name',
                                        'order' => 'ASC',
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
                                <label for="cars-state-selector">Estados</label>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
                                <label for="cars-city-selector">Ciudades</label>
