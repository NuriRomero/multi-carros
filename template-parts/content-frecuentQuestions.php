                            ...
                            <div class="comments-area">
                                ...
                                <ul class="comments-list">
                                     <?php                                   // Obtén las preguntas frecuentes
                                        $faq_group = get_post_meta(get_the_ID(), '_faq_faq_group', true);
                                        ...
                                        if ($faq_group) {
                                            ...
                                            foreach ($faq_group as $group) {
                                                ...
                                                echo '<h4 class="author-name">' . esc_html($group['_faq_question']) . '<h4 class="date"></h4></h4>';
                                                echo '<h6 class="reply">' . esc_html($group['_faq_answer']) . '</h6>';
                                                echo '</div>';
                                                echo '</div>';
                                                echo '</li>';
                                            }
