...
(function ($) {
	...
	// ====== Isotope js
	$( ".masonry-place-area" ).imagesLoaded(
		function () {
					...
					success: function (data) {
						...
						data.forEach(
                            ...
                            cars_grid_html += ` < div class = "col-md-6 col-sm-12" >
								...
								< div class     = "listing-thumbnail" >
								< img src       = "${element.post_thumbnail_url}" > < / img >
								< span class = "featured-btn" > ${element.condicion} < / span >
								< / div >
								< div class  = "listing-content" >
								< h3 class  = "title" > < a href = "${element.permalink}" > ${element.title} < / a > < / h3 >
								< div class = "listing-meta" >
	...
	$( "#cars-condition-selector" ).change(
		function () {
			$.ajax(
				{
					url: cars.ajaxurl,
					...
					success: function (data) {
						...
						data.forEach(
                            ...
                            cars_grid_html += ` < div class = "col-md-6 col-sm-12" >
								...
								< div class  = "listing-content" >
								< h3 class = "title" > < a href = "${element.permalink}" > ${element.title} < / a > < / h3 >
								< span class = "phone-meta" > < / i > ${element.precio} < / span >
								< div class  = "listing-meta" >
								< ul >
									< li > < span > < i class = "ti-location-pin" > < / i > ${element.ciudad} < / span > < / li >
									< li > < span > < i class = "ti-heart" > < / i > < a href = "#" > Save < / a > < / span > < / li >
					...
					success: function (data) {
						...
						data.forEach(
                            ...
                            cars_grid_html += ` < div class = "col-md-6 col-sm-12" >
								...
								< div class  = "listing-content" >
								< h3 class   = "title" > < a href = "${element.permalink}" > ${element.title} < / a > < / h3 >
								< span class = "phone-meta" > < i class = "ti-tablet" > < / i > ${element.precio} < / span >
								< div class                             = "listing-meta" >
								< ul >
									< li > < span > < i class = "ti-location-pin" > < / i > ${element.ciudad} < / span > < / li >
									< li > < span > < i class = "ti-heart" > < / i > < a href = "#" > Save < / a > < / span > < / li >
